    ...
    public static  class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
                new AppConfig() { Key = "HomTitle", Value = "This is home page of eShopWebApp" },
                new AppConfig() { Key = "HomKeyword", Value = "This is keyword of eShopWebApp" },
                new AppConfig() { Key = "HomDescription", Value = "This is description of eShopWebApp" }
           ...
           new Product()
           {
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "thuha10032001@gmail.com",
                NormalizedEmail = "thuha10032001@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "VoHa@2022"),
                SecurityStamp = string.Empty,
                FirstName = "Toan",
                LastName = "Bach",
                Dob = new DateTime(2022, 09, 22)
            });
